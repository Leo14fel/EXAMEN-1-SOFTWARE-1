...
**Incluye:** estrategia de undo/redo con snapshots completos y un maximo fijo de 100 estados de undo; al superar el limite se descarta el snapshot mas antiguo.
